        ...
        <div class="my-4">
            <form method="POST" action="movies.jsp">
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <input type="text" name="genre" class="form-control" placeholder="Genre (comma-separated)" required>
                    </div>
                    <div class="col-md-2">
                        <input type="number" name="duration" class="form-control" placeholder="Duration (mins)" required>
                    </div>
                    <div class="col-md-3">
                        <input type="text" name="poster_url" class="form-control" placeholder="Poster URL" required>
                    </div>
                    <div class="col-md-6 mt-2">
                        <textarea name="synopsis" class="form-control" placeholder="Synopsis" rows="2" required></textarea>
                    </div>
